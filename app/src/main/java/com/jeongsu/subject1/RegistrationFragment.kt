...
class RegistrationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView= inflater.inflate(R.layout.fragment_registration, container, false)
        nameText=rootView.findViewById(R.id.editName)
        phoneNumberText=rootView.findViewById(R.id.editNumber)
        registBtn=rootView.findViewById(R.id.registButton)
        return rootView
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        registBtn.setOnClickListener{
            ...
            db.collection("info").add(savedData)
